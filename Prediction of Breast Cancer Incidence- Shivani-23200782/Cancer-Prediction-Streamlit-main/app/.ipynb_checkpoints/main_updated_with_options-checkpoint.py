...
def main():
    ...
    option = st.radio("What would you like to do?", ("Upload an Image", "Enter Cell Nuclei Measurements", "Input Patient Data"))
    ...
    elif option == "Enter Cell Nuclei Measurements":
    ...
    elif option == "Input Patient Data":
