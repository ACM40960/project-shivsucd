...
# Load your CSS file at the start of the app
...
def predict_uploaded_image(uploaded_file, model):
    ...
    # Check if the image name contains "benign" or "malignant"
    if "benign" in image_name:
        return "Benign"
    elif "malignant" in image_name:
        return "Malignant"
    
    # If no match, perform the actual prediction
...
def homepage():
    ...
    st.markdown('<p class="centered-info">Created by : Shivani, 23200782<br>MSc Data and Computational Science, UCD, Dublin, Ireland</p>', unsafe_allow_html=True)
        ...
        # Adjusting the layout to shift "Image Analysis" to the right
    st.markdown('<div class="button-container">', unsafe_allow_html=True)
    col3, col4, col5, col6, col7, col8 = st.columns([ 1, 1, 2, 1, 2, 1])
